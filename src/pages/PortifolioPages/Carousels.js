const Carousels = ({ testimonials }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 justify-items-between items-center md:gap-x-5 gap-y-6 md:gap-y-0 w-full pt-16 pb-40">
      {testimonials.map((testmony) => (
        <div className="w-full border-2 border-black rounded-md shadow-md py-10 aspect-video">
